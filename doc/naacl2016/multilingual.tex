...
% \hline
% \end{tabular}
% \caption{Splitting the entities in a multilingual AKBC training set into parts. We only require that sets B and D overlap. Remarkably, we can train a model for the low-resource language even if C is empty.}
% \label{tab:multilingual-corpora}
% \end{center}
% \end{table}
