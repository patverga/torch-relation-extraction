...
-- data file locations
cmd:option('-train', '../data/new/train-mtx.torch', 'torch format train file list')
cmd:option('-test', '../data/new/test-mtx-torch/0-test.mtx', 'torch format test file list')
...
-- rnn specific
cmd:option('-bi', false, 'Use a bidirectional lstm')
